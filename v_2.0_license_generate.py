...
res = generate_license_file("2022-07-10", "2022-07-31", 500, "FDDC152D-FCF7-48DD-914F-1C46AF2411F4", "commercial", "admin")
# 将加密后的数据生成一个License文件
# new_uuid = str(uuid.uuid4())
with open("authorization.license", "w") as f:
    f.write(res)
